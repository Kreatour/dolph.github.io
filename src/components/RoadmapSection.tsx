      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-black mb-6">
            <span className="text-gradient-ocean">The Pod's Journey</span> 🗺️
          </h2>
          <p className="text-xl text-aqua-light max-w-2xl mx-auto">
            Our roadmap to becoming the apex dolphin of TON
          </p>
        </div>
              ...
              <div key={index} className="relative">
                ...
                {index < roadmapStages.length - 1 && (
                  <div className="hidden md:block absolute top-8 left-full w-8 h-0.5 bg-aqua-bright/30 z-0">
                    <ArrowRight className="absolute -top-2 -right-1 w-4 h-4 text-aqua-bright" />
                  </div>
                )}

                <div className={`card-ocean relative z-10 ${stage.status === 'current' ? 'border-aqua-bright shadow-dolphin' : ''}`}>
                  {/* Stage Header */}
